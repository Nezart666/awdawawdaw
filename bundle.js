...
, function(e, t, n) {
            ...
            r.connect(c, (function(e) {
                ...
                function() {
                    for (var e = 0; e < jn.length; ++e) {
                        ...
                        ,
                        t.src = jn[e] == "crosshair" ? "https://i.imgur.com/RablLHj.png" : ".././img/icons/" + jn[e] + ".png",
                        Rn[jn[e]] = t
                    }
                }(),
    ...
    , ct = {
        name: "lxxl",
        link: "https://www.youtube.com/channel/UCOqpoK4_x0cwPzS-0Jw-Rdg"
    };
    ...
    function Mn(e, t, n, i) {
        m.showText(e, t, 60, .18, 500, Math.abs(n), n >= 0 ? "#db6e6e" : "#8ecc51")
    }
    var An = 99999;
    function Pn() {
        le = !1;
                ...
                e.exports.AnimText = function(){
                    this.init = function(e, t, n, i, r, s, a){
                        this.x = e, this.y = t, this.color = a, this.scale = n, this.startScale =
                            this.scale + 15, this.minScale = 30, this.scaleSpeed = .7, this.speed =
                            i * .5, this.life = 1500, this.text = s
                    }, this.update = function(e){
                        this.life && (this.life -= e, this.y -= this.speed * e, this.scale *= .98, this.scale < this.minScale ? (this.scale = this.minScale,
                                                                                                                                 this.scaleSpeed *= -15) : this.scale >= this.startScale && (this.scale =
                                                                                                                                            this.startScale, this.scaleSpeed = 0), this.life <= 0 && (this.life =
					0))
                    }, this.render = function(e, t, n){
                        e.strokeStyle = '#3d3f42', e.fillStyle = this.color, e.font = this.scale + "px Hammersmith One", e.strokeText(
                            this.text, this.x - t, this.y - n), e.fillText(
...
, function(e, t, n) {
    ...
    s.prototype.pingServers = function() {
        var e = this
          , t = [];
        for (var n in window.vultr.servers)
            if (window.vultr.servers.hasOwnProperty(n)) {
                var i = window.vultr.servers[n]
                    ...
                    s.onreadystatechange = function(i) {
                        ...
                        if (4 == s.readyState)
                            if (200 == s.status) {
                                ...
                                console.warn("Error pinging " + r.ip + " in region " + r.region)
                    }
                    ;
